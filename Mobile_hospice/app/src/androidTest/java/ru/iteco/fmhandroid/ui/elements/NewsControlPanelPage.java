...
public class NewsControlPanelPage {
    ...
    public static String descriptionVisitors;
    ...
    public NewsControlPanelPage() {
        ...
        titleAdvertisement = "Общее собрание в 12 часов";
        descriptionAdvertisement = "Голосование за кандидата";
        categorySalary = "Зарплата";
        titleSalary = "Зачисление зарплаты";
        descriptionSalary = "Зарплата за прошлый месяц";
        titleVisitors = "Прием посетителей";
        descriptionVisitors = "Объяснить правила посещения";
        categoryBirthday = "День рождения";
        descriptionBirthday = "Купить торт";
        titleSalaryEnumerated = "Премиальные начисления";
        descriptionSalaryEnumerated = "За сверхурочные работы";
        categoryUnion = "Профсоюз";
        titleUnion = "Юридическая консультация";
        descriptionUnion = "Договор найма";
        categoryCelebration = "Праздник";
        titleCelebration = "День города";
        customCategory = "Прогулка";
        customCategoryTitle = "Парк Победы";
        customCategoryDescription = "Сходить на концерт";
        numbersCategory = "789456";
        numbersCategoryTitle = "Собрание";
        numbersCategoryDescription = "Перенос праздника";
        specialCharactersCategory = "%:!*;№!:?.";
        specialCharactersCategoryTitle = "Новый кабинет массажа";
        specialCharactersCategoryDescription = "Составить расписание";
        categoryGratitude = "Благодарность";
        titleGratitude = "Всем сотрудникам";
        descriptionGratitude = "За профессионализм";
        categoryNeedHelp = "Нужна помощь";
        titleNeedHelp = "Пациентам";
        descriptionNeedHelp = "Сбор";
        titleGratitudeDonations = "Михаилу Зубову";
        descriptionGratitudeDonations = "За большой вклад";
        titleBirthdayEdit = "Семен Аносов";
        descriptionBirthdayEdit = "День рождения";
    }
}