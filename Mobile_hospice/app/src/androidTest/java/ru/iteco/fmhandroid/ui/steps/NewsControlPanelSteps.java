...
import static ru.iteco.fmhandroid.ui.elements.NewsControlPanelPage.descriptionVisitors;
...
import static ru.iteco.fmhandroid.ui.elements.NewsControlPanelPage.titleVisitors;
...
public class NewsControlPanelSteps {
    ...
    static String nextYear = "15.04.2027";
    ...
    public static String getTitleVisitors() {
        return titleVisitors;
    }

    public static String getDescriptionVisitors() {
        return descriptionVisitors;
    }
